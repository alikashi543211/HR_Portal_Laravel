...
<head>
    ...
    <title>Devstudio - Wiki</title>
    <link href="{{ asset('employeesAsset/css/icons.css') }}" type="text/css" rel="stylesheet" />
    <link href="{{ asset('employeesAsset/css/login.css') }}" type="text/css" rel="stylesheet" />
    <link rel="icon" href="{{ url('newassets/images/favicon.png') }}" type="image/x-icon" />
        ...
        <div class="login-content">
            <div class="login-form-content">
                <div class="login-logo text-center">
                    <!-- <h1><span>Dev</span><span class="other-color">Studio</span>
                            <div class="labelWiki">wiki</div></h1> -->
                    <img src="{{ asset('assets/Devstudios_logo.png') }}">
                </div>
                <!-- <div class="sign-links">
                        <a href="javascript:;" class="active">Signin</a>
                        <a href="javascript:;">Sign Up</a>
                    </div> -->
                @yield('content')
            </div>
            <div class="info" style="background:linear-gradient(45deg, black, rgba(85, 26, 139, 0.25), black), url(quotes/) no-repeat; background-size:cover;">
                <div>
                    <!-- <div>
                            <img src="{{ url('newassets/images/login-img.png') }}" alt="">
                        </div> -->
    ...
    <script>
        $(document).ready(function() {
            ...
            var animation = bodymovin.loadAnimation({
                container: document.getElementById('s-wrapper'),
                renderer: 'svg',
                loop: false,
                autoplay: true,
                path: '{{ url('svg/data.json') }}'
            });
        });
    </script>
    <script>
