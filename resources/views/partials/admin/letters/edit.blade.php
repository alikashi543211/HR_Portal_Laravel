...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <div>
                <div class="col-md-12">
                    <form method="post" action="{{url(config('data.admin.letters.update'))}}">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                <textarea name="body" id="description" class="form-control" rows="20">{{ $data->body }} {{ old('description') ? old('description') : '' }}</textarea>
                            </div>
                        </div>
                        <div class="row">
