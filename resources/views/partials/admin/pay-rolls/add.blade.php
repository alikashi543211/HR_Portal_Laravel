            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-8 offset-2">
                        ...
                        <form method="post" action="{{url(config('data.admin.payroll.save'))}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-6 form-group offset-3">
                                    <label>Date</label>
                                    <input name="date" type="text" autocomplete="off" id="datepicker" class="form-control" required />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 form-group offset-3">
